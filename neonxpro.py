...
bot = telebot.TeleBot('7521710402:AAHAIHAfDuNyszsI5aJue2thCj0vXc9Ck7A')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"𝙔𝙊𝙐𝙍 𝘼𝙏𝙏𝘼𝘾𝙆 𝙎𝙏𝘼𝙍𝙏𝙀𝘿 𝙎𝙐𝘾𝘾𝙀𝙎𝙎𝙁𝙐𝙇𝙇𝙔 𝘽𝙔 𝙉𝙀𝙊𝙉𝙓𝙋𝙍𝙊 ✅ "
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                response = "❌ 𝙀𝙍𝙍𝙊𝙍 𝙐𝙎𝙀 𝙇𝙀𝙎𝙎 𝙏𝙃𝙀𝙉 600 𝙎𝙀𝘾𝙊𝙉𝘿𝙎 ❌."
            else:
                ...
                response = f"𝘽𝙂𝙈𝙄 𝘿𝘿𝙊𝙎 𝘼𝙏𝙏𝘼𝘾𝙆 𝙁𝙄𝙉𝙄𝙎𝙃𝙀𝘿 𝘽𝙔 𝙉𝙀𝙊𝙉𝙓𝙋𝙍𝙊 ❤️"
        else:
...
def welcome_start(message):
    ...
    response = f"❤️ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙉𝙀𝙊𝙉𝙓𝙋𝙍𝙊 𝙃𝙐𝘽 𝘼𝙇𝙇 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝘼𝙑𝘼𝙄𝙇𝘼𝘽𝙇𝙀 𝙊𝙉 𝙈𝙀𝙉𝙐. 𝙅𝙊𝙄𝙉 𝙊𝙐𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 @NEONXPROHUB"
    bot.reply_to(message, response)
